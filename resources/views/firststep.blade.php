...
<script>
        ...
        for (var i = 0; i < 50; i++) {
            var latLng = new google.maps.LatLng(12.5 - Math.random(), 77.3 - Math.random());
            var marker = new google.maps.Marker({
            position: latLng,
        ...
        for (var i = 0; i < 20; i++) {
            var latLng = new google.maps.LatLng(12.7 - Math.random(), 77.3 - Math.random());
            var marker = new google.maps.Marker({
            position: latLng,
            icon: 'https://img.icons8.com/color/48/000000/car--v2.png',
            label: "" + i,
        ...
        for (var i = 0; i < 5; i++) {
            var latLng = new google.maps.LatLng(12.9 - Math.random(), 77.3 - Math.random());
            var marker = new google.maps.Marker({
            position: latLng,
            icon: 'https://img.icons8.com/color/48/000000/car--v2.png',
            label: "" + i,
        ...
        $(document).ready(function() {
            ...
            $(".btn-submit").click(function(e){
                ...
                $.ajax({
                    ...
                    type:'POST',
                    data: { from_location:fromlocation, to_location:tolocation,request_time:apptime,services:services,user_id:userid,status:status},
